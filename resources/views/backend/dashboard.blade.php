        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <div class="bg-gray-50 text-gray-800 grid grid-cols-1 md:grid-cols-3 px-15 py-10">
                    ...
                    <div class="px-5">
                        <div class="flex items-center">
                            <div class="text-lg leading-7 font-semibold"><a href="https://shop.harshitpeer.com/themes-and-services-for-tmail/" target="_blank">{{ __('Themes and Services') }}</a></div>
                        </div>
                        <div class="">
                            <div class="mt-2 text-sm">
                            ...
                            <a href="https://shop.harshitpeer.com/themes-and-services-for-tmail/" target="_blank">
                                <div class="mt-3 flex items-center text-sm font-semibold text-indigo-700">
                                    <div>{{ __('Get Themes and Services') }}</div>
                                    <div class="ml-1 text-indigo-500">
                                        <svg viewBox="0 0 20 20" fill="currentColor" class="w-4 h-4"><path fill-rule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                                    </div>
                                </div>
